                                        ...
                                        <tr className="hover:bg-slate-50 transition-colors">
                                            ...
                                            <td className="py-4 px-4 text-right">
                                                <div className="flex items-center justify-end gap-2">
                                                    ...
                                                    <a href={`/admin/posts/edit?file=${encodeURIComponent(post.path)}&type=post`} title="Editar Completo" className="p-2 text-slate-400 hover:text-slate-600 hover:bg-slate-100 rounded-lg transition-colors"><FileText className="w-4 h-4" /></a>
